...
class _LiveViewerScreenState extends State<LiveViewerScreen> {
  ...
  // Royalty free loopable graffiti street dancer clip representing live stream feed
  static const String liveStreamSampleUrl =
      'https://assets.mixkit.co/videos/preview/mixkit-girl-dancing-in-front-of-a-graffiti-wall-44754-large.mp4';
  ...
  void initState() {
    ...
    // Initialize Video Player to simulate viewing host stream
    _videoPlayerController = VideoPlayerController.networkUrl(Uri.parse(liveStreamSampleUrl))
      ..initialize().then((_) {
        if (mounted) {
          setState(() {
